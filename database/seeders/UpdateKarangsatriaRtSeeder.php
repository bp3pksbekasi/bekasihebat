...
class UpdateKarangsatriaRtSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 1. Perbaiki nama wilayah RW 1 dan RW 9
        ...
        $this->command->info("Nama wilayah RW 1 dan 9 diperbarui.");
        ...
        foreach ($rt_counts as $rw => $count) {
            ...
            ProfilRw::where('target_wilayah_id', $target->id)
                    ->where('nomor_rw', $paddedRw)
                    ->update(['jumlah_rt' => $count]);
        }
        
        $this->command->info("Jumlah RT untuk 32 RW berhasil diupdate!");
    }
}
