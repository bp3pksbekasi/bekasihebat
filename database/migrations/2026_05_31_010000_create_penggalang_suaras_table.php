...
return new class extends Migration
{
    ...
    {
        Schema::create('penggalang_suaras', function (Blueprint $table) {
            ...
            $table->integer('target_jangkauan')->default(10);
            $table->integer('realisasi_jangkauan')->default(0);
    ...
    {
        Schema::dropIfExists('penggalang_suaras');
    }
};
