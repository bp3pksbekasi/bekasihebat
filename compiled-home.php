...
<style>
    ...
    .hero-media {
        ...
        background-image:
            ...
            url('<?php echo e(asset('images/hero.jpg')); ?>');
        ...
        <div class="hero-content fade-up">
            <div class="hero-panel">
                ...
                <div class="hero-actions">
                    <a href="<?php echo e(route('register')); ?>" class="hero-btn primary"><i class="ti ti-user-plus"></i> Bergabung Sekarang</a>
                ...
                <div class="hero-stats">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                        ...
                        <div class="hero-stat">
                            <div class="num" data-counter="<?php echo e($item['value']); ?>">0</div>
        ...
        <?php else: ?>
            <div class="event-grid-public">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php($eventImageUrl = $event->cover_image ? '/storage/' . ltrim($event->cover_image, '/') : null)
                    <article class="event-card-public fade-up">
                        <div class="event-image-public">
                            ...
                            <div class="event-type-public">{{ $event->jenis_label }}</div>
                        </div>
                        <div class="event-body-public">
                            ...
                            <a href="{{ route('public.events.show', $event->slug) }}" class="event-btn-public">Daftar Sekarang</a>
                        </div>
                    </article>
                @endforeach
            </div>
    ...
    <div class="container">
        ...
        <div class="program-grid-public">
            @foreach ($programs as $program)
                @php($palette = $programCardPalette[$program['key']] ?? ['bg' => '#fff3ee', 'color' => '#fe5000'])
                <div class="program-card-public fade-up">
...
<section class="section" id="berita">
    <div class="container">
        <div class="section-header center fade-up">
            <div class="section-tag orange">Kabar Terbaru</div>
            <h2 class="section-title">Berita & Kegiatan</h2>
        </div>
        @if ($newsFeatured)
            @php($featuredNewsImageUrl = $newsFeatured->thumbnail ? '/storage/' . ltrim($newsFeatured->thumbnail, '/') : null)
            <div class="news-layout-public fade-up">
                <div class="news-featured-public" style="display:flex; flex-direction:column; justify-content:space-between; height:100%;">
                    <div>
                    ...
                    <div style="padding:0 24px 24px 24px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="{{ route('public.berita.show', $newsFeatured->slug) }}" wire:navigate style="font-size:13px; font-weight:700; color:#ea580c; text-decoration:none; display:inline-flex; align-items:center; gap:4px; transition:0.2s;" onmouseover="this.style.color='#fe5000'" onmouseout="this.style.color='#ea580c'">
                ...
                <div class="news-list-public">
                    @foreach ($newsList as $item)
                        @php($newsThumbUrl = $item->thumbnail ? '/storage/' . ltrim($item->thumbnail, '/') : null)
...
<section class="section section-white" id="dprd">
    <div class="container">
        <div class="section-header center fade-up">
        ...
        @else
            <div class="gallery-grid-public fade-up">
                @foreach ($galleryItems as $index => $item)
                    @php($galleryImagePath = $item->file_path ?: $item->thumbnail)
                    @php($galleryImageUrl = $galleryImagePath ? '/storage/' . ltrim($galleryImagePath, '/') : null)
                    <div class="gallery-item-public {{ $index === 0 ? 'featured' : '' }}">
                        @if ($galleryImageUrl)
        ...
        <div class="fade-up" style="display:grid;grid-template-columns:minmax(0,1.2fr) minmax(320px,.8fr);gap:20px;" id="aspirasi-home-grid">
            <div style="padding:28px;border-radius:24px;background:linear-gradient(135deg,#1a3a6b,#0d1f3c);color:white;box-shadow:0 10px 30px rgba(13,31,60,0.15);display:flex;flex-direction:column;justify-content:space-between;">
                ...
                <div>
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                        <div>
                            ...
                            <div style="font-size:48px;font-weight:900;line-height:1.1;margin-top:6px;letter-spacing:-0.03em;"><?php echo e(number_format($totalAspirasi)); ?></div>
                        </div>
                    ...
                    <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:24px;">
                        <div class="aspirasi-stat-box" style="padding:14px;border-radius:14px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,0.04);transition:0.2s;">
                            ...
                            <div style="font-size:24px;font-weight:800;margin-top:4px;"><?php echo e(number_format($aspirasiStats['sipd'])); ?></div>
                        </div>
                        <div class="aspirasi-stat-box" style="padding:14px;border-radius:14px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,0.04);transition:0.2s;">
                            ...
                            <div style="font-size:24px;font-weight:800;margin-top:4px;"><?php echo e(number_format($aspirasiStats['dianggarkan'])); ?></div>
                        </div>
                        <div class="aspirasi-stat-box" style="padding:14px;border-radius:14px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,0.04);transition:0.2s;">
                            ...
                            <div style="font-size:24px;font-weight:800;margin-top:4px;"><?php echo e(number_format($aspirasiStats['terealisasi'])); ?></div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top:28px;">
                        <div style="display:flex;justify-content:space-between;font-size:12px;color:rgba(255,255,255,0.7);margin-bottom:8px;font-weight:500;">
                            ...
                            <span style="color:#22c55e;font-weight:700;"><?php echo e($pctTerealisasi); ?>% Terealisasi</span>
                        </div>
                        <div style="height:10px;border-radius:999px;background:rgba(255,255,255,0.1);overflow:hidden;display:flex;gap:2px;">
                            <div style="width:<?php echo e($pctTerealisasi); ?>%;background:#22c55e;" title="Terealisasi: <?php echo e($pctTerealisasi); ?>%"></div>
                            <div style="width:<?php echo e($pctDianggarkan); ?>%;background:#ea580c;" title="Dianggarkan: <?php echo e($pctDianggarkan); ?>%"></div>
                            <div style="width:<?php echo e($pctSipd); ?>%;background:#3b82f6;" title="Masuk SIPD: <?php echo e($pctSipd); ?>%"></div>
                        </div>
                        <div style="display:flex;gap:12px;margin-top:12px;font-size:11px;flex-wrap:wrap;color:rgba(255,255,255,0.8);">
                            <div style="display:flex;align-items:center;gap:4px;">
                                ...
                                <span>Terealisasi (<?php echo e($pctTerealisasi); ?>%)</span>
                            </div>
                            <div style="display:flex;align-items:center;gap:4px;">
                                <span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#ea580c;"></span>
                                <span>Dianggarkan (<?php echo e($pctDianggarkan); ?>%)</span>
                            </div>
                            <div style="display:flex;align-items:center;gap:4px;">
                                <span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:#3b82f6;"></span>
                                <span>Masuk SIPD (<?php echo e($pctSipd); ?>%)</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top:32px;border-top:1px solid rgba(255,255,255,0.1);padding-top:24px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;">
                    ...
                    <a href="<?php echo e(route('public.aspirasi')); ?>" wire:navigate style="background:white;color:#1a3a6b;font-weight:700;padding:10px 20px;border-radius:12px;font-size:13px;text-decoration:none;box-shadow:0 4px 14px rgba(0,0,0,0.15);transition:0.2s;display:inline-flex;align-items:center;gap:6px;" onmouseover="this.style.background='#fff3ee'; this.style.color='#fe5000'" onmouseout="this.style.background='white'; this.style.color='#1a3a6b'">
                        Kirim Aspirasi <i class="ti ti-arrow-right" style="font-size:14px;"></i>
                    </a>
                </div>
            </div>
            <div style="display:grid;gap:10px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $aspirasiStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="padding:14px;border-radius:14px;border:1px solid #ececea;background:#fff;box-shadow:0 2px 12px rgba(0,0,0,.06);">
                        <div style="font-size:14px;font-weight:700;color:#1a1a18;"><?php echo e($story->judul); ?></div>
                        <div style="font-size:11px;color:#9a9890;margin-top:4px;"><?php echo e($story->desa ?: '-'); ?> · <?php echo e($story->assignedDewan?->nama ?? 'Dewan PKS'); ?></div>
                        <div style="font-size:12px;color:#166534;font-weight:700;margin-top:8px;"><?php echo e($story->anggaran_nominal ? 'Rp '.number_format((float) $story->anggaran_nominal, 0, ',', '.') : 'Progres realisasi tercatat'); ?></div>
                    </div>
                ...
                <a href="<?php echo e(route('public.aspirasi')); ?>" class="hero-btn primary" style="justify-content:center;">
...
<section class="cta-public" id="daftar">
    <div class="container">
        <div class="fade-up">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn"><i class="ti ti-id-badge-2"></i> Daftar & Dapatkan Kartu Anggota</a>
        </div>
    </div>
</section>
