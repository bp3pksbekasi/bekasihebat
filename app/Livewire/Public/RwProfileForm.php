        ...
        if ($rw) {
            ...
            \App\Models\ProfilRw::updateOrCreate(
                ...
                [
                    ...
                    'profil_warga' => $this->profil_warga,
                    'profil_warga_keterangan' => $this->profil_warga_keterangan,
                    'suara_pks_2019' => $this->suara_pks_2019,
                    'faktor_penyebab' => $this->faktor_penyebab,
                    'faktor_penyebab_keterangan' => $this->faktor_penyebab_keterangan,
                    ...
                    'strategi_keterangan' => $this->strategi_keterangan,
