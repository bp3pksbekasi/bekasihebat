<div style="display:flex; flex-direction:column; height:100%; background:#fff;">
    ...
    <div style="flex:none; background:linear-gradient(135deg,#0D1B3D,#122B5A); color:#fff; padding:12px 20px; display:flex; justify-content:space-between; align-items:center; box-shadow:0 2px 8px rgba(0,0,0,0.25);">
        ...
        <div style="display:flex; gap:10px; align-items:center; flex-shrink:0;">
            <a href="{{ route('public.pilkades-karangsatria.download-prioritas') }}" target="_blank" style="background:#16a34a; border:1px solid #15803d; padding:4px 12px; border-radius:6px; font-size:0.85rem; font-weight:600; color:#fff; text-decoration:none; display:flex; align-items:center; gap:4px; transition:opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
