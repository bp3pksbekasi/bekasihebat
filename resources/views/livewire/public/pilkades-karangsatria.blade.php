                        ...
                        <tr style="background:{{ $bg }};">
                            ...
                            <td style="position:relative; background:{{ $row['korwe_nama'] ? '#f0fdf4' : $bg }}; border-bottom:1px solid #e2e8f0; border-right:1px solid #e2e8f0; padding:7px 8px; text-align:center;">
                                <div style="display:flex; align-items:center; justify-content:center; gap:6px;">
                                    ...
                                    {{-- Edit Icon --}}
                                    <button wire:click="openKorweModal({{ $row['nomor_rw'] }})" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Data Korwe">
                            ...
                            <td style="position:relative; background:{{ match($row['afiliasi']) { 'UNO' => '#dcfce7', 'CALON LAIN' => '#fee2e2', 'NETRAL' => '#f1f5f9', default => $bg } }}; border-bottom:1px solid #e2e8f0; border-right:1px solid #e2e8f0; padding:7px 8px; text-align:center;">
                                ...
                                {{-- Edit Icon --}}
                                <button wire:click="openAfiliasiModal({{ $row['nomor_rw'] }})" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Afiliasi">
                            ...
                            <td style="position:relative; background:{{ match($row['afiliasi_pkk']) { 'UNO' => '#dcfce7', 'CALON LAIN' => '#fee2e2', 'NETRAL' => '#f1f5f9', default => $bg } }}; border-bottom:1px solid #e2e8f0; border-right:1px solid #e2e8f0; padding:7px 8px; text-align:center;">
                                ...
                                @endif
                                <button wire:click="openEditFieldModal({{ $row['nomor_rw'] }}, 'afiliasi_pkk', 'Afiliasi PKK')" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Afiliasi PKK">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width:14px; height:14px;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                </button>
                            </td>
                            ...
                            <td style="position:relative; background:{{ match($row['afiliasi_karang_taruna']) { 'UNO' => '#dcfce7', 'CALON LAIN' => '#fee2e2', 'NETRAL' => '#f1f5f9', default => $bg } }}; border-bottom:1px solid #e2e8f0; border-right:1px solid #e2e8f0; padding:7px 8px; text-align:center;">
                                ...
                                @else
                                    <span style="display:inline-block; color:#475569; font-size:0.85rem;">-</span>
                                @endif
                                <button wire:click="openEditFieldModal({{ $row['nomor_rw'] }}, 'afiliasi_karang_taruna', 'Afiliasi Karang Taruna')" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Afiliasi Karang Taruna">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width:14px; height:14px;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                </button>
                            </td>
                            ...
                            <td style="position:relative; background:{{ match($row['afiliasi_dkm']) { 'UNO' => '#dcfce7', 'CALON LAIN' => '#fee2e2', 'NETRAL' => '#f1f5f9', default => $bg } }}; border-bottom:1px solid #e2e8f0; border-right:1px solid #e2e8f0; padding:7px 8px; text-align:center;">
                                ...
                                @else
                                    <span style="display:inline-block; color:#475569; font-size:0.85rem;">-</span>
                                @endif
                                <button wire:click="openEditFieldModal({{ $row['nomor_rw'] }}, 'afiliasi_dkm', 'Afiliasi DKM')" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Afiliasi DKM">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width:14px; height:14px;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                </button>
                            </td>
                            ...
                            <td style="position:relative; background:{{ match($row['afiliasi_tokoh']) { 'UNO' => '#dcfce7', 'CALON LAIN' => '#fee2e2', 'NETRAL' => '#f1f5f9', default => $bg } }}; border-bottom:1px solid #e2e8f0; border-right:2px solid #cbd5e1; padding:7px 8px; text-align:center;">
                                ...
                                @else
                                    <span style="display:inline-block; color:#475569; font-size:0.85rem;">-</span>
                                @endif
                                <button wire:click="openEditFieldModal({{ $row['nomor_rw'] }}, 'afiliasi_tokoh', 'Afiliasi Tokoh')" style="position:absolute; top:2px; right:2px; background:transparent; border:none; padding:2px; cursor:pointer; color:#475569; outline:none; transition:color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color='#94a3b8'" title="Ubah Afiliasi Tokoh">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width:14px; height:14px;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                </button>
                            </td>
