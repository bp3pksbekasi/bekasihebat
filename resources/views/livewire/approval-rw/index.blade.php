        ...
        <div style="position:fixed;top:0;right:0;width:560px;max-width:100%;height:100%;background:white;box-shadow:-8px 0 24px rgba(0,0,0,0.16);z-index:50;overflow-y:auto;display:flex;flex-direction:column;">
            ...
            <div style="flex:1;padding:28px 24px;">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-sm text-gray-800">
                    ...
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Partai Pemenang (Pemilu Lalu)</span> <div class="font-medium text-gray-900">{{ $detailRecord->partai_dominan ?? '-' }}</div></div>
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Afiliasi Ketua RW</span> <div class="font-medium text-gray-900">{{ $detailRecord->afiliasi_ketua_rw ?? '-' }}</div></div>
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Afiliasi Mayoritas RT</span> <div class="font-medium text-gray-900">{{ $detailRecord->afiliasi_mayoritas_rt ?? '-' }}</div></div>
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Afiliasi Tokoh Masyarakat</span> <div class="font-medium text-gray-900">{{ $detailRecord->afiliasi_tomas ?? '-' }}</div></div>
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Afiliasi Tokoh Agama</span> <div class="font-medium text-gray-900">{{ $detailRecord->afiliasi_toga ?? '-' }}</div></div>
                    <div class="col-span-1 md:col-span-2"><span class="text-gray-500 block text-xs mb-1 uppercase tracking-wider font-semibold">Afiliasi Tokoh Pemuda</span> <div class="font-medium text-gray-900">{{ $detailRecord->afiliasi_pemuda ?? '-' }}</div></div>
