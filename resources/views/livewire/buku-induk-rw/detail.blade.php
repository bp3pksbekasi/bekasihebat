<div>
    <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
            ...
            @if($korweCount === 0)
                <div class="bg-red-50 text-red-700 px-4 py-2 rounded-lg text-sm border border-red-200 flex items-center">
            ...
            <button @click="$dispatch('open-infra-drawer')" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                ...
                <form wire:submit.prevent="simpanInfrastruktur" class="space-y-4" x-data="{ type: @entangle('infraType') }">
                    ...
                    <div class="pt-4 mt-6 border-t border-gray-100">
                        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3.5 rounded-lg transition-colors shadow-sm flex items-center justify-center gap-2" wire:loading.attr="disabled">
                            <span wire:loading.remove wire:target="simpanInfrastruktur">
                            ...
                            <span wire:loading wire:target="simpanInfrastruktur">
                                Menyimpan...
                            </span>
                        </button>
                    </div>
