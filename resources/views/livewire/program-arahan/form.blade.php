    ...
    <div style="width:100%;margin:0;box-sizing:border-box;">
        ...
        <div style="background:#1a1a1a;color:white;padding:12px 20px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;border-radius:14px 14px 0 0;">
            <div style="display:flex;align-items:center;gap:12px;">
                ...
                <div>
                    <div style="font-size:15px;font-weight:500;">{{ $pageTitle ?? 'Form Program Arahan' }}</div>
                ...
                <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:4px;">
                    ...
                    @if($isEdit ?? false)
                        ...
                        <button wire:click="simpanDanAjukan" type="button" style="height:40px;padding:0 20px;border-radius:10px;border:none;background:#fe5000;color:white;font-size:13px;font-weight:600;cursor:pointer;">
                            <span wire:loading.remove wire:target="simpanDanAjukan">Simpan Perubahan</span>
        ...
        <div style="background:white;border:0.5px solid #e5e5e5;border-radius:12px;padding:16px;">
            ...
            <div>
                <div style="display:grid;gap:14px;grid-template-columns:1fr 1fr;">
                    <div>
                        ...
                        <select wire:model.live="lokasiDapil" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                    ...
                    <div>
                        ...
                        <select wire:model.live="lokasiKecamatan" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                    ...
                    <div>
                        ...
                        <select wire:model.live="lokasiDesa" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                    ...
                    <div>
                        ...
                        <select wire:model.live="nomorRw" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ empty($this->rwOptions) || ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                ...
                <div style="display:grid;gap:14px;margin-top:14px;">
                    <div>
                        ...
                        <select wire:model="jenisProgram" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                        <div>
                            ...
                            <input wire:model="targetAngka" type="number" min="0" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                        </div>
                        <div>
                            <label style="font-size:11px;color:#666;display:block;margin-bottom:5px;">Satuan (Opsional)</label>
                            <input wire:model="satuan" type="text" placeholder="Orang, Titik, RW..." style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:grid;gap:14px;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                        <div>
                            ...
                            <select wire:model.live="orgLevel" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
                        ...
                        <div>
                            ...
                            <select wire:model="bidangDpdId" style="width:100%;height:40px;border-radius:8px;border:0.5px solid #d4d4d8;padding:0 12px;font-size:13px;" {{ ($fieldsLocked ?? false) ? 'disabled' : '' }}>
            ...
            <div>
                ...
                <div style="display:flex;justify-content:space-between;margin-top:24px;padding-top:16px;border-top:0.5px solid #e5e5e5;">
                    <button wire:click="prevStep" type="button" style="padding:8px 18px;border-radius:8px;background:#f4f4f5;color:#444;border:0.5px solid #d4d4d8;font-size:13px;font-weight:600;cursor:pointer;"><i class="ti ti-arrow-left"></i> Sebelumnya</button>
                    <div>
                        @if(($isEdit ?? false) && ($fieldsLocked ?? false))
                            <button wire:click="simpanDanAjukan" type="button" style="padding:8px 18px;border-radius:8px;background:#16a34a;color:white;border:none;font-size:13px;font-weight:600;cursor:pointer;">Simpan Perubahan</button>
                        @else
                            <button wire:click="simpanDanAjukan" type="button" style="padding:8px 18px;border-radius:8px;background:#16a34a;color:white;border:none;font-size:13px;font-weight:600;cursor:pointer;">{{ ($isEdit ?? false) ? 'Ajukan Pembaruan' : 'Ajukan Program' }}</button>
                        @endif
                    </div>
                </div>
            </div>
