    ...
    <body class="min-h-screen bg-[#0f0f10] text-zinc-100">
        ...
        @php
            ...
            $menus = [
                ...
                ['route' => 'infra-rtrw.index', 'slug' => 'infra-rtrw', 'label' => 'Infra RT/RW', 'icon' => 'building-community', 'active' => ['infra-rtrw.*']],
                ...
                [
                    ...
                    'active' => ['bedah-dapil.*'],
                    'children' => [
                        ['route' => 'bedah-dapil.pemilu-dprd', 'slug' => 'bedah-dapil', 'label' => 'Pemilu DPRD', 'active' => ['bedah-dapil.pemilu-dprd']],
                        ['route' => 'bedah-dapil.analisa-caleg', 'slug' => 'bedah-dapil', 'label' => 'Analisa Caleg', 'active' => ['bedah-dapil.analisa-caleg']],
                    ],
                ],
